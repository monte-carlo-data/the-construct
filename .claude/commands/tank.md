...
- **Real finding:** Check system ownership in `knowledge/System_Ownership.md`, comment on
...
1. **Check system ownership** — look up the affected system in `knowledge/System_Ownership.md`.
